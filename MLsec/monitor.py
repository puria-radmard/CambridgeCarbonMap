...
from genie_master.src.main import predict
import pandas as pd
import time
...
path = "C:\\Users\\puria\\source\\repos\\puria-radmard\\CambridgeCarbonMap\\MLsec\\images"
os.chdir(path)
cwd = os.getcwd()
print(cwd)
#fileName = "image.jpg"
...
class Monitor(object):
    def __init__(self, dt):
        ...
        self.times = deque(maxlen = maxtime)
...
monitor = Monitor(5)                                        # Needs fixing for variable dt
